...
import com.cherry.dtos.ELKDocumentResponseDto;
...
public class ElasticSearchDocumentService {
    ...
    public CommonResult createDocument(ELKDocumentDto documentVo) throws JsonProcessingException {
        log.info("开始文档创建：{}", documentVo);
        IndexRequest indexRequest = new IndexRequest(documentVo.getIndex());
        User user = documentVo.getUser();
        IndexRequest source = indexRequest.source(objectMapper.writeValueAsString(user), XContentType.JSON);
        try {
            IndexResponse index = restHighLevelClient.index(indexRequest, RequestOptions.DEFAULT);
            ELKDocumentResponseDto response = new ELKDocumentResponseDto();
    ...
    public CommonResult updateDocument(ELKDocumentDto documentVo) throws JsonProcessingException {
